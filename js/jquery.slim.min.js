...
!(function (e, t) {
        ...
        for (l = a[a.length - 1].ownerDocument, E.map(a, Le), c = 0; c < s; c++)
          (u = a[c]),
            pe.test(u.type || "") &&
              ...
              E.contains(l, u) &&
              (u.src && "module" !== (u.type || "").toLowerCase() ? E._evalUrl && !u.noModule && E._evalUrl(u.src, { nonce: u.nonce || u.getAttribute("nonce") }, l) : C(u.textContent.replace(Se, ""), u, l));
    }
    return n;
  }
  function Oe(e, t, n) {
  ...
  function Be(e, t, n) {
    ...
    return (
      (n = n || He(e)) &&
        ...
        !m.pixelBoxStyles() && Pe.test(a) && Re.test(t) && ((r = s.width), (i = s.minWidth), (o = s.maxWidth), (s.minWidth = s.maxWidth = s.width = a), (a = n.width), (s.width = r), (s.minWidth = i), (s.maxWidth = o))),
      void 0 !== a ? a + "" : a
    );
  }
  function Me(e, t) {
      ...
      attr: function (e, t, n) {
        ...
        if (3 !== o && 8 !== o && 2 !== o)
          return "undefined" == typeof e.getAttribute
            ? E.prop(e, t, n)
            : ((1 === o && E.isXMLDoc(e)) || (i = E.attrHooks[t.toLowerCase()] || (E.expr.match.bool.test(t) ? Ze : void 0)),
              void 0 !== n
                ? null === n
        ...
        return (
          ...
          r ||
            ...
            (u &&
              b(n[p]) &&
              !x(n) &&
              ((a = n[u]) && (n[u] = null), (E.event.triggered = p), e.isPropagationStopped() && f.addEventListener(p, ut), n[p](), e.isPropagationStopped() && f.removeEventListener(p, ut), (E.event.triggered = void 0), a && (n[u] = a))),
          e.result
        );
      }
    },
  ...
  (E.param = function (e, t) {
    ...
    (m.createHTMLDocument = (((lt = w.implementation.createHTMLDocument("").body).innerHTML = "<form></form><form></form>"), 2 === lt.childNodes.length)),
